...
*/
    ...
    @objc func LibProfileingabeAktion(_ notification:Notification)
    {
        ...
        print("LibProfileingabeAktion KoordinatenTabelle: \(KoordinatenTabelle)")
        ...
        infodic!["spannweite"] = Spannweite
        
   //     let eingabedic = info! as NSDictionary
        
        
        AVR?.libProfileingabeFunktion(infodic)
        ...
        let itemtag = popitem.tag

        
        ProfilFeld.setScale(derScalefaktor:CGFloat(itemtag))
        ...
        if var ProfilDic = notification.userInfo
        {
            ...
            let temparray1mirror = self.vertikalspiegelnVonProfil(profilarray: temparray1)
            ...
            print("temparray1: \(temparray1) \n Profil1OberseiteArray: \(Profil1OberseiteArray)")
            
            Profil2Array = ProfilDic["profil2array"] as! [Double]
            Profil2UnterseiteArray = ProfilDic["unterseitearrayB"] as! [Double]
            let temparray2 = ProfilDic["oberseitearrayB"] as! [Double]
            Profil1OberseiteArray = CNC_Eingabe.vertikalspiegelnVonProfil(temparray2)
*/
...
*/
    ...
    @objc override func newDataAktion(_ notification:Notification)  // entspricht readUSB
    {
       ...
       print("arHotwireController newDataAktion notification: \n\(notification)\n lastData:\n \(lastData)")
